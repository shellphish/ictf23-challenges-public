    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='https://ictf.cs.ucsb.edu/' class='snake-link'>Welcome to iCTF 2023</a> - <a href='https://github.com/patorjk/JavaScript-Snake' class='snake-link'>Game Originally Developed by patorjk</a>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "iCTF 2023 Snake Game<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. Use the <strong>space</strong> key to pause. " + fullScreenText + "<p></p>";
        ...
        me.setPaused = function(val) {
            ...
            if (isPaused) {
                ...
                elmPauseScreen.innerHTML = "<div style='padding:10px;'>[Paused]<p/>" + result + "<p/>Press [space] to unpause.</div>";
            } else {
